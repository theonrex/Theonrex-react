...
function About() {
	...
	return (
		<div>
			...
			<div className="container services-mg">
									...
									<div className="accordion-body">
										<div className="grid-container">
											<div className="grid-item ">
												<div>
													<div
														className="accordion accordion-flush grid-hide"
														id="accordionFlushExample"
													>
														<div className="accordion-item">
															<h2
															...
															<div className="package-col ">
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			{" "}
																			Stand out from the crowd with a logo that
																...
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			{" "}
																			Get your main message across with
																...
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			{" "}
																			Crush the first impression with custom
															...
															<div className="package-col ">
																...
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			Promote your business with printed
																			marketing materials you can post anywhere
																			and everywhere
																		</p>
																	</div>
																	<p className="package-click">
																...
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			Allow your creativity to shine with a
																			captivating book design
																		</p>
																	</div>
																	<p className="package-click">
																		{" "}
															...
															<div className="package-col ">
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			Enticing menus and price lists for your
																			restaurant, special event, and more!
																		</p>
																	</div>
																	<p className="package-click">
																		{" "}
																...
																<div className="package-mini">
																	...
																	<div className="package-text">
																		...
																		<p>
																			PMake shoppers look twice with creative
